...
import {Button, Grid, TextField, FormHelperText, FormControl, Radio, RadioGroup, FormControlLabel, Typography, Collapse} from "@material-ui/core";
...
export default class CreateRoomPage extends Component{
    ...
    handleRoomButtonPress(){
        ...
        fetch('/api/create-room', requestOptions).then((res) => res.json()).then((data) => this.props.history.push("/room/" +  data.code));
    }
    ...
    renderUpdateButtons(){
        return(
            <Grid item xs={12} align="center">
                <Button color="secondary" variant="contained" onClick={this.handleUpdateButtonPress}>Update Room</Button>
            </Grid>
        )
    }
    render(){
        ...
        return(
            ...
            >
              ...
              />
                ...
                <Grid item xs={12} align="center">
                    <FormControl>
                        <TextField required={true} type="number" onChange={this.handleVotesChange} defaultValue={this.state.votesToSkip} inputProps={{min:1, style:{textAlign:"center"}}}></TextField>
